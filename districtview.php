                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="districtadd.php" class="btn btn-primary float-end">Add District</a>
                                <h4>Registered District</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <table id="myDataTable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = "SELECT * FROM district WHERE statusdistrict !='2'";
                                        ...
                                        if (mysqli_num_rows($query_run) > 0) {
                                            ...
                                            foreach ($query_run as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row['namedistrict']; ?></td>
                                                    
                                                    <td>
                                                        <?php
                                                        if ($row['statusdistrict'] == '1') {
                                                            echo 'Hidden';
                                                        } else {
                                                            echo 'Vsible';
                                                        }
                                                    ...
                                                    <td><a href="districtedit.php?id=<?= $row['iddistrict']; ?>" class="btn btn-success">Edit</a></td>

                                                    <td>
                                                        <form action="code.php" method="POST">
                                                            <button type="submit" name="districtdelete" value="<?= $row['iddistrict']; ?>" class="btn btn-danger">Delete</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                                <?php
