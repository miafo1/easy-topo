                ...
                <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
                    ...
                    <nav id="navbar" class="navbar">
                        <ul>
                            ...
                            <li class="dropdown"><a href="products.php"><span>Book a land</span> <i
                                ...
                                <form action="code.php" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="checkbox" width="70px" height="70px" name="status" value="1"/>Available
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <button type="submit" class="btn btn-primary" name="categoryadd">Save Town</button>
                                        </div>
                                    </div>
                                </form>                         
                            </div>
