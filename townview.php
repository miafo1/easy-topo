                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="townadd.php" class="btn btn-primary float-end">Add Town</a>
                                <h4>Registered Town</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <table id="myDataTable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = "SELECT * FROM town WHERE statustown !='2'";
                                        ...
                                        if (mysqli_num_rows($query_run) > 0) {
                                            ...
                                            foreach ($query_run as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="townedit.php?id=<?= $row['idtown']; ?>" class="btn btn-success">Edit</a></td>

                                                    <td>
                                                        <form action="code.php" method="POST">
                                                            <button type="submit" name="towndelete" value="<?= $row['idtown']; ?>" class="btn btn-danger">Delete</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                                <?php
