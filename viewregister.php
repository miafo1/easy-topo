...
//                enable the town select dropdown
        ...
        <body class="sb-nav-fixed">
            ...
            <div class="container-fluid px-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="registeradd.php" class="btn btn-primary float-end">Add User/Admin</a>
                            ...
                            <div class="card-body">
                                ...
                                <table id="myDataTable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = "SELECT u.*, r.nameregion, t.nametown, d.namedistrict 
                                        FROM user u
                                        JOIN region r ON u.idregion = r.idregion
                                        JOIN town t ON u.idtown = t.idtown
                                        JOIN district d ON u.iddistrict = d.iddistrict";
                ...
                <td><?= $row['lname']; ?></td>
                <td><?= $row['email']; ?></td>
                <td><?= $row['nameregion']; ?></td> <!-- Display Region Name -->
                <td><?= $row['nametown']; ?></td>   <!-- Display Town Name -->
                <td><?= $row['namedistrict']; ?></td> <!-- Display District Name -->
                <td><?= ucfirst($row['role_as']); ?></td>
