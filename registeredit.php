        ...
        < class="card-body">
            ...
            if(isset($_GET['id'])) {
                ...
                if(mysqli_num_rows($users_run) > 0) {
                    ...
                    // Fetching region, town, district data
                    $regions_query = "SELECT * FROM region";
                    $towns_query = "SELECT * FROM town WHERE idregion=" . $user['idregion'];
                    $districts_query = "SELECT * FROM district WHERE idtown=" . $user['idtown'];

                    $regions_run = mysqli_query($con, $regions_query);
                    $towns_run = mysqli_query($con, $towns_query);
                    $districts_run = mysqli_query($con, $districts_query);
                ?>
                ...
                <form action="code.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="idregion" id="region" class="form-control" onchange="fetchTowns(this.value)">
                            <option value="">--Select Region--</option>
                            <?php
                            foreach ($regions_run as $region) {
                                ?>
                                <option value="<?= $region['idregion']; ?>" <?= $region['idregion'] == $user['idregion'] ? 'selected' : '' ?>><?= $region['nameregion']; ?></option>
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="idtown" id="town" class="form-control" onchange="fetchDistricts(this.value)">
                            <option value="">--Select Town--</option>
                            <?php
                            foreach ($towns_run as $town) {
                                ?>
                                <option value="<?= $town['idtown']; ?>" <?= $town['idtown'] == $user['idtown'] ? 'selected' : '' ?>><?= $town['nametown']; ?></option>
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="iddistrict" id="district" class="form-control">
                            <option value="">--Select District--</option>
                            <?php
                            foreach ($districts_run as $district) {
                                ?>
                                <option value="<?= $district['iddistrict']; ?>" <?= $district['iddistrict'] == $user['iddistrict'] ? 'selected' : '' ?>><?= $district['namedistrict']; ?></option>
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="role_as" required class="form-control">
                            ...
                            <option value="surveyor" <?= $user['role_as'] == 'surveyor' ? 'selected' : '' ?>>Surveyor</option>
                            <option value="notary" <?= $user['role_as'] == 'notary' ? 'selected' : '' ?>>Notary</option>
                            <option value="client" <?= $user['role_as'] == 'client' ? 'selected' : '' ?>>Client</option>
                        </select>
                    </div>
...
<script>
    function fetchTowns(regionId) {
        // Fetch towns based on selected region
        // Implement AJAX or redirect for dynamic updates
    }

    function fetchDistricts(townId) {
        // Fetch districts based on selected town
        // Implement AJAX or redirect for dynamic updates
    }
</script>
