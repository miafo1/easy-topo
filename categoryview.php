...
<html>
    ...
    <html lang="en">
        ...
        <head>
            ...
            <link href="easytopocss/jquery.dataTables.min.css" rel="stylesheet" />
            <link href="easytopocss/dataTables.bootstrap5.min.css" rel="stylesheet" />
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="categoryadd.php" class="btn btn-primary float-end">Add Land</a>
                                <h4>VIEW LAND</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="myDataTable" class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php
//                                            $query = "SELECT * FROM land WHERE statusland !='2'";
                                            $query = "SELECT l.*, r.nameregion AS rname, t.nametown AS tname, d.namedistrict AS dname FROM land l, region r, town t, district d WHERE l.idregion = r.idregion AND l.idtown = t.idtown AND l.iddistrict = d.iddistrict ";
                                            ...
                                            if (mysqli_num_rows($query_run) > 0) {
                                                ...
                                                foreach ($query_run as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $row['tname']; ?></td>
                                                        <td><?= $row['dname']; ?></td>
                                                        <td><?= $row['descriptionland']; ?></td>
                                                        <td><?= $row['uniteprice']; ?></td>
                                                        <td><?= $row['totalprice']; ?></td>
                                                        <td><?= $row['titleland']; ?></td>
                                                        <td><?= $row['size']; ?></td>
                                                        <td><?= $row['land_purpose']; ?></td>
                                                        <td><?= $row['land_type']; ?></td>

                                                        <td> <img src="uploads/posts/<?= $row['imageland']; ?>" width="60px" height="60px"/></td>

                                                        <td>
                                                           
                                                        <?php
                                                            if ($row['statusland'] == 'reserved') {
                                                                echo 'Reserved'; // When status is 'reserved'
                                                            } else {
                                                                echo 'Available'; // When status is 'available'
                                                            }
                                                            ?>
                                                        </td>
                                                        <td><?= $row['locationland']; ?></td>
                                                        <td><a href="categoryedit.php?id=<?= $row['idland']; ?>" class="btn btn-success">Edit</a></td>

                                                        <td>
                                                            <form action="code.php" method="POST">
                                                                <button type="submit" name="categorydelete" value="<?= $row['idland']; ?>" class="btn btn-danger">Delete</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                    <?php
            ...
            <!-- Vendor JS Files -->
            <script src="easytopojs/jquery-3.7.1.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
            ...
            <script src="easytopojs/jquery.dataTables.min.js"></script>
            <script src="easytopojs/dataTables.bootstrap5.min.js"></script>
            <script>
