                            ...
                            <div class="card-body">
                                <form action="code.php" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="">Disteict Name</label>
                                            <input type="text" required name="namedistrict" required="" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <button type="submit" class="btn btn-primary" name="districtadd">Save District</button>
                                        </div>
                                    </div>
                                </form>                         
                            </div>
