                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="regionadd.php" class="btn btn-primary float-end">Add Region</a>
                                <h4>Registered Region</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        if (mysqli_num_rows($query_run) > 0) {
                                            ...
                                            foreach ($query_run as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="regionedit.php?id=<?= $row['idregion']; ?>" class="btn btn-success">Edit</a></td>

                                                    <td>
                                                        <form action="code.php" method="POST">
                                                            <button type="submit" name="regiondelete" value="<?= $row['idregion']; ?>" class="btn btn-danger">Delete</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                                <?php
