                ...
                <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
                    ...
                    <nav id="navbar" class="navbar">
                        <ul>
                            ...
                            <li><a href="projects.html" class="active">Propose your land</a></li>
...
<!--            ==========================================ADMINISTRATIVE PANEL===============================================-->
        ...
        <div id="layoutSidenav_content">
            <div class="container-fluid px-4">
                        <h1 class="mt-4">EASY-TOPO MANAGEMENT </h1>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Total number of land active  
                                         <?php
                                        $dash_land_query = "SELECT * from land WHERE statusland = 'available'";
                                        $dash_land_query_run = mysqli_query($con, $dash_land_query);
                                        
                                        if($land_total = mysqli_num_rows($dash_land_query_run)){
                                            echo '<h4 class="mb-0">'.$land_total.'</h4>';
                                        }else{
                                            echo '<h4 class="mb-0">No Data</h4></div>';  
                                        }
                                        ?>
                                        </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Total number of region  
                                        <?php
                                        $dash_region_query = "SELECT * from region WHERE statusregion = '0'";
                                        $dash_region_query_run = mysqli_query($con, $dash_region_query);
                                        
                                        if($region_total = mysqli_num_rows($dash_region_query_run)){
                                            echo '<h4 class="mb-0">'.$region_total.'</h4>';
                                        }else{
                                            echo '<h4 class="mb-0">No Data</h4></div>';  
                                        }
                                        ?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Total number of town
                                         <?php
                                        $dash_town_query = "SELECT * from town WHERE statustown = '0'";
                                        $dash_town_query_run = mysqli_query($con, $dash_town_query);
                                        
                                        if($town_total = mysqli_num_rows($dash_town_query_run)){
                                            echo '<h4 class="mb-0">'.$town_total.'</h4>';
                                        }else{
                                            echo '<h4 class="mb-0">No Data</h4></div>';  
                                        }
                                        ?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Total users 
                                        <?php
                                        $dash_user_query = "SELECT * from user WHERE status = '0'";
